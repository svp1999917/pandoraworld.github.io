...
let projects = [
  {
    image: 'textures/worldkorealanka.png',
    url: 'https://worldkorealanka.lk/',
  },
  {
    image: 'textures/happyflix.jpeg',
    url: 'https://svp1999917.github.io/sahanperera.github.io/happyflix/',
  },
  {
    image: 'textures/studentms.png',
    url: 'https://www.appsheet.com/newshortcut/e587d17c-8c9a-4f80-a872-9ff926e4e3ef',
  },
  {
    image: 'textures/salesms.png',
    url: 'https://www.appsheet.com/newshortcut/6c788ba3-3dfd-4890-bdf6-4055cf8cf8cb',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('SAHAN PERERA', {
      font: font,
      size: 0.10,
      height: 0.02,
    });
    ...
    titleText.position.set(-0.27, 0.55, 0.58);
    scene.add(titleText);
  });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    subtitleText.position.set(-0.255, 0.5, 0.58);
...
function init3DWorldClickListeners() {
  ...
  window.addEventListener('click', function (e) {
    ...
    intersects.forEach((intersect) => {
      ...
      // Check if clicked object is the computer monitor
      if (intersect.object.name === 'Monitor') {
        // Open your other website in a new tab
        window.open('https://sahanperera.great-site.net/', '_blank');      
      }
    });
  });
}
